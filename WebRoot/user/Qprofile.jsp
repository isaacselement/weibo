...
.content .main .feedList ul li .feedCon{
	width: 100%;
}
  ...
  <div class="dbWrapW">
	...
	<div class="dbWrap">
		...
		<div class="container">
		  ...
		  <div class="top">
		  	<div class="logo">
		  		<a class="logo_iQ" href="/weibo/list!listPosttopic.do" title="我的i轻博客_iQing">我的iQing</a>
		  		
		  		<div class="nav">
					<a  href="/weibo/logout.do" title="" ><span>退出</span></a>
					<a  href="/weibo/member!init.do" title="" ><span>帐号设置</span></a>
					<a  href="/weibo/list!listMessage.do" title="" ><span>我的私信</span></a>
					<a  href="/weibo/space/friend.jsp" title="" ><span>我的好友</span></a>
		  ...
		  <div class="content">
		  	...
		  	<div class="main">
		  		...
		  		<div class="feedList">
		  			<ul id="theLatestFeed">
		  				<li>
		  					<div class="headPic" style="display: none;">
