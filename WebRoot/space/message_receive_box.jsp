...
<html>
	...
	function deleteMessage() {
		...
		if (window.confirm("确认删除吗？")) {
			with (document.getElementById("messageForm")) {
				method = "post";
				action = "message!deleteReciever.do?pageModel.pageNo=${pageModel.pageNo}&pageModel.pageSize=${pageModel.pageSize}";
				submit();
			}
		}
	}
	...
	function listMessageByReciever() {
		with (document.getElementById("messageForm")) {
			method = "post";
			action = "message!listMessageByReciever.do?reciever=${member.username}&pageModel.pageSize=6";//设置每页显示的记录数量
			submit();
		}
	}
	...
	function topPage() {
		with (document.getElementById("messageForm")) {
			method = "post";
			action = "message!listMessageByReciever.do?pageModel.pageNo=${pageModel.topPageNo}&pageModel.pageSize=${pageModel.pageSize}";
			submit();
		}
	}
	...
	function previousPage() {
		with (document.getElementById("messageForm")) {
			method = "post";
			action = "message!listMessageByReciever.do?pageModel.pageNo=${pageModel.previousPageNo}&pageModel.pageSize=${pageModel.pageSize}";
			submit();
		}
	}
	...
	function nextPage() {
		with (document.getElementById("messageForm")) {
			method = "post";
			action = "message!listMessageByReciever.do?pageModel.pageNo=${pageModel.nextPageNo}&pageModel.pageSize=${pageModel.pageSize}";
			submit();
		}
	}
	...
	function bottomPage() {
		with (document.getElementById("messageForm")) {
			method = "post";
			action = "message!listMessageByReciever.do?pageModel.pageNo=${pageModel.bottomPageNo}&pageModel.pageSize=${pageModel.pageSize}";
			submit();
		}
	}
